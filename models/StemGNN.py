...
This file is from BasicTS
https://github.com/zezhishao/BasicTS/blob/master/basicts/archs/arch_zoo/stemgnn_arch/stemgnn_arch.py

Because the official code lacks reproducibility
"""
